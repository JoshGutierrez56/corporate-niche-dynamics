"""Independently validate the frozen P12E power calibration."""
...
from hypercube.power_calibration import validate_power_calibration_outputs
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("artifacts/manifests/p12e_power_calibration_validation.json"),
    )
